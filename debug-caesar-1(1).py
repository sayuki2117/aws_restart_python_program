print("\n=====Welcome to Python - Debugging the Caesar Cipher Program=====\n")
print("\n=====Exercise 1: Working with the buggy Caesar cipher program - Part 1=====\n")

""" In the Functions lab, you created a Caesar cipher program to encrypt and decrypt a message.\
In code i use the Python Debugger (pdb) to find and fix errors in buggy versions of the program."""
